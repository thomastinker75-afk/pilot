...
export const APP_AUDITS: Record<string, AppAudit> = {
  ...
  "whoUses": "Teens 13+, heavily. Younger children often appear via family accounts or unofficial accounts made with a false age.",
  "ukControls": "Meta describes Teen Accounts with protective content and contact settings, parental supervision and age-assurance measures. Its June 2026 update announced further rollouts. Check the actual account settings and current Family Center guidance; rollout wording is not proof every account has every feature.",
  "topRisks": [
  ...
  "whoUses": "The default friend-to-friend messenger for UK teens, and widely used by 10–12-year-olds despite the 13 limit.",
  "ukControls": "Family Centre lets a linked parent see who their teen has messaged in the last seven days (not the content), report accounts and restrict sensitive Stories content. Age checks apply to some 18+ features; the sign-up age itself is self-declared.",
  "topRisks": [
  ...
  "whoUses": "Used for personal and group messaging; this review does not establish how many UK children use it.",
  ...
  "whoUses": "Teens who game, plus fandom and study communities. Younger children are often invited into servers linked to Roblox, Minecraft or Fortnite.",
  "ukControls": "Discord says UK users receive protective defaults. Confirmed adult status is required to access age-restricted spaces or change certain content and message-request settings. Its filters cover images and videos, not messages, voice or calls.",
  "topRisks": [
  ...
  telegram: {
    ...
    "whoUses": "The current terms require UK users to be at least 18; this is not a measure of actual users’ ages.",
    "ukControls": "Telegram’s terms set 18+ for the UK. This review has not established the effectiveness of its age checks; do not assume a rule guarantees exclusion of children.",
    "topRisks": [
  ...
  "whoUses": "Ofcom finds YouTube is the most-used platform by UK children aged 3–17. For most families it has replaced television.",
  "ukControls": "Google applies age estimation in the UK and asks for ID or a card for age-restricted content. For under-13s there is YouTube Kids or a supervised Google account with three content settings: Explore (9+), Explore More (13+) and Most of YouTube.",
  "topRisks": [
  ...
  twitch: {
  "whatItIs": "Live-streaming platform, mostly gaming, with live chat, private Whispers, paid subscriptions, ‘bits’ donations and clips.",
  "whoUses": "Teens who follow gaming creators and esports, and younger children watching Minecraft, Fortnite and Roblox streamers.",
  "ukControls": "Twitch’s terms set a minimum of 13 (or a higher applicable local age). Users below the age of legal majority must use it under a parent or guardian’s supervision and agreement. This is not a guarantee of age-appropriate live content.",
  "topRisks": [
  ...
  kick: {
  "whatItIs": "A newer live-streaming rival to Twitch, funded by and closely tied to an online casino, with deliberately looser content moderation.",
  "whoUses": "Teens who follow creators banned or restricted elsewhere; smaller than Twitch but growing fast, and often unfamiliar to parents.",
  "ukControls": "Minimum age 13, self-declared. Moderation is lighter than mainstream platforms and policies change frequently, so any guidance dates quickly.",
  "topRisks": [
  ...
  "conversationStarter": "“Do you watch anyone on Kick? I'd like to see one of their streams with you — I've read the site is much less moderated than Twitch.”",
  ...
  minecraft: {
    ...
    "whoUses": "Children from about age 6 through the teens, on console, PC, tablet and phone.",
    "ukControls": "Microsoft child accounts provide parent-managed multiplayer and communication permissions. These are distinct from the game’s PEGI rating. Controls vary by edition and version.",
    "topRisks": [
  ...
  vrchat: {
  "whatItIs": "Social virtual reality: user-made 3D worlds entered as an avatar, with live voice chat and full-body movement, mostly on Meta Quest headsets.",
  "whoUses": "Teens with a headset, and a substantial number of under-13s. Adult users are the majority.",
  ...
  yubo: {
    ...
    "whoUses": "The current terms permit adults aged 18 and over. Older references to a separate teenage community are obsolete.",
    "ukControls": "The June 2026 terms describe automated age estimation at sign-up. A minimum-age rule is not a guarantee that every account is correctly aged.",
    "topRisks": [
    ...
    "auditNote": "Minimum age checked against Yubo terms on 21 September 2026. No independent effectiveness test of age estimation."
  },
  ...
  "whoUses": "Older teens following sport, gaming, politics and fandoms; less used by younger children than TikTok or Snapchat.",
  "ukControls": "X describes several age-assurance methods for sensitive media, including account signals and user-provided verification. Check its current help page for the options offered to your account.",
  "topRisks": [
  ...
  reddit: {
  "whatItIs": "A network of user-run forums (‘subreddits’) covering every interest, with voting, anonymous accounts, DMs and chat.",
  "whoUses": "Older teens, especially for gaming, hobbies, revision help and advice communities. Rarely a first app for younger children.",
  "ukControls": "Reddit requires age confirmation for UK users accessing mature or restricted content. Its current help page describes Apple account confirmation on iOS or Persona selfie or ID options.",
  "topRisks": [
  ...
  "whoUses": "Teens and university students; smaller than the main platforms but sticky within friendship groups.",
  "ukControls": "Minimum age 13, self-declared, with no UK age check. Discovery, location and privacy behaviour change with updates and should be rechecked regularly.",
  "topRisks": [
  ...
  "whoUses": "The age rules below describe eligibility, not verified audience statistics.",
  "ukControls": "NGL does not permit under-18s. Sendit’s operator, Iconic Hearts, sets a minimum of 13 and requires parental consent for users under 18. A platform minimum is not a recommendation that an app is suitable for every child.",
  "topRisks": [
  ...
  "conversationStarter": "“Some of those anonymous messages are written by the app itself to make you pay for a hint. Can I show you what the regulator found?”",
  ...
  "whoUses": "Mainly adults. Part of the wider AI companions cluster alongside Character.AI, and teens do find it.",
  "ukControls": "17+ on the App Store and 18+ in Replika's own terms. Italy's data regulator ordered it to stop processing Italian users' data over child-protection failings. Age assurance is weak.",
  "topRisks": [
